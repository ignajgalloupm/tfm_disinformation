...
class Train:
    ...
    def __init__(self, device, train_loader, loss_fn1, loss_fn2, optimizer, model_name, vdb, emb_gen):
        self.device = device
    ...
    def train_epoch(self, epoch, vdb, emb_gen, nli, tracking_train, tracking_eval=None, super_batch=10, ma_ratio=None):
        self.train_super_step(self.sub_dataloader, emb_gen, nli, super_batch, epoch, 0, tracking_train, tracking_eval, ma_ratio)
        return True